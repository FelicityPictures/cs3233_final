...
if pagenumber == 1 { // CLOTHES
	...
	if c4 == 1 { // BAD
		draw_text_ext_transformed(x, y+headersp1, "You decided to get fish and chips for dinner.", headerls1, 400, 2, 2, 0);
		...
		draw_text_ext_transformed(x, y+headersp1, "You decided to get a chicken sandwich for dinner.", headerls1, 400, 2, 2, 0);
