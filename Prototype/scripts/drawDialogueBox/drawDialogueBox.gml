...
draw_text_transformed(margin+padding+outlineWeight, room_height-margin-outlineWeight-boxHeight+padding, text, 2, 2, 0)
draw_text_transformed(margin+padding+outlineWeight, room_height-margin-outlineWeight-boxHeight+padding+lineHeight, text, 2, 2, 0)